...
**Signals** are the intent behind all of your interview questions. Coming up with them is the most critical part of defining 
your interview process, and allows you to work backwards to solid questions. Signals should be derived from the actual work
you are doing, and what you expect a candidate to be able to perform. For example, signals I've used in the past:
...
From there you can further refine each signal (e.g. "what do we value in a code review?") and then design questions to clearly
reveal that signal.
